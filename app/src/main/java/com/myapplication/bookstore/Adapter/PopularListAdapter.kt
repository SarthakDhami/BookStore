...
import com.myapplication.bookstore.MainActivity
import com.myapplication.bookstore.R
import com.myapplication.bookstore.WebViewActivity

class PopularListAdapter(var context: Context, var imageIdList: Array<Int>, var popularBookName: List<String>,val itemClick : OnClickListner) :RecyclerView.Adapter<PopularListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.tv_PopBookName.setText(popularBookName[position])
        holder.img_book.setImageResource(imageIdList[position])
        holder.img_book.setOnClickListener { view->
            itemClick.setOnItemClick(view,position)
